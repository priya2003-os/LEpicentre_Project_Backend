...
import co.simplon.epicentre.entities.Role;
import co.simplon.epicentre.entities.User;
import co.simplon.epicentre.repositories.UserRepository;
import co.simplon.epicentre.security.Jwt;
import co.simplon.epicentre.security.JwtProvider;
...
public class UserServiceImpl implements UserService {
    ...
    @Transactional
    @Override
    public void create(UserCreateDto inputs) {
	User user = new User();
    ...
    @Override
    public Jwt signIn(UserSignInDto inputs) throws BadCredentialsException {
